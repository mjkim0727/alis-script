...
        2)
            pacman -Sy
            pacman -S plasma plasma-wayland-session dolphin dolphin-plugins firefox konsole ark kate elisa ktorrent vlc kde-pim-meta unrar noto-fonts-cjk noto-fonts-emoji noto-fonts ttf-hack fcitx5 fcitx5-gtk kcm-fcitx5 print-manager flatpak packagekit-qt5
...
        3)
            pacman -Sy
            pacman -S xfce4 xfce4-screenshooter xed xreader firefox engrampa papirus-icon-theme mate-calc xfce4-taskmanager xfce4-terminal thunar-archive-plugin shotwell vlc evolution highlight evolution-spamassassin rhythmbox libgpod gvfs xdg-user-dirs lightdm lightdm-gtk-greeter lightdm-gtk-greeter-settings qt5ct kvantum flatpak
            sed -i '/%wheel ALL=(ALL) ALL/s/^#//' /etc/sudoers
